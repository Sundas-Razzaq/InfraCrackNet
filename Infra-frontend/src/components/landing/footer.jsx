        ...
        <footer className="landing-footer-shell">
            <div className="container">
                <div
                    ...
                    aria-label="Footer"
                >
                    <section className="col-lg-5 col-md-4 landing-footer-brand-col">
                    ...
                    <section className="col-lg-3 col-md-4 landing-footer-links-col" aria-label="Product">
                    ...
                    <section className="col-lg-4 col-md-4 landing-footer-links-col" aria-label="Legal">
